        ...
        if (v74 == 0) then
            ...
            if (v75 and v75.Character) then
                ...
                v9:BindToRenderStep(v7("\241\231\60\190\169\253\0","\107\178\134\81\210\198\158"), Enum.RenderPriority.Camera.Value + 1, function()
                    if (v12 and v12.Character and v12.Character:FindFirstChild(v7("\16\27\143\199\151\244\122\138"))) then
                        if (v13 == false) then
                            v13 = true
                            local v96 = 1 + 0
                            while true do
                                if (v96 == 1) then
                                    v9.MouseIconEnabled = false
                                    break
                                end
                            end
                        end
...
local v59
v59 = game:GetService("UserInputService").InputBegan:Connect(function(v80, v81)
    if (v80.UserInputType == Enum.UserInputType.MouseButton2) then -- Changed to MouseButton2
        v58()
    end
end)

local v60
v60 = game:GetService("UserInputService").InputEnded:Connect(function(v82, v83)
    if (v82.UserInputType == Enum.UserInputType.MouseButton2) then
        if (v12) then
            v56(v12, false)
            v12 = nil
            v9.MouseIconEnabled = true
            v13 = false
        end
    end
end)
